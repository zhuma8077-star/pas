...
<nav class="navbar navbar-expand-lg navbar-dark bg-success">
    <div class="container">
        <a class="navbar-brand" href="index.jsp">
            <i class="fas fa-clinic-medical"></i> Admin Panel
        </a>
...
<div class="container text-center">
    ...
    <p>Manage appointments, doctors, users, and notifications.</p>
        ...
        <div class="col-md-3">
            <div class="card bg-secondary text-white">
                <div class="card-body">
                    ...
                    <a href="contact-dashboard.jsp" class="btn btn-light">Manage</a>
                </div>
            </div>
        </div>
